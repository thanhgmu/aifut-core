...
3. Turn the new adapter-plan/application-assessment docs into the smallest implementation-ready contract slice, starting with shared adapter interface definitions plus the first `AppDefinition` seed set for the five primary systems.
...
- Latest checked local HEAD: `a5a3b6d` (`docs(architecture): assess perfex nexovaflow v1`).
